<h1 align="center">Hi, I'm Sarah Sair </h1>
<h3 align="center">Generative AI & LLM Engineer | Systems Architect</h3>

<p align="center">
  <em>"Most AI demos break. I build the systems that don't."</em>
</p>

<p align="center">
  📍 Chicago, IL &nbsp;·&nbsp; LLM Systems &nbsp;·&nbsp; RAG &nbsp;·&nbsp; Prompt Engineering &nbsp;·&nbsp; AI Automation &nbsp;·&nbsp; Data Engineering
</p>
...
I spent 13+ years building IT infrastructure before moving into AI — and that background shapes everything about how I work. I don't just build things that demo well; I build things that hold up under edge cases, under load, and over time.
...
Few-shot, Chain-of-Thought, and ReAct prompting · RAG pipelines with retrieval, grounding & structured output · LLM evaluation frameworks, hallucination detection, and benchmarking across GPT-4, Claude, LLaMA, and Gemini

**AI Automation & Systems Design**
End-to-end workflow automation in Python · Multi-step AI pipelines designed for real-world failure modes · Human-in-the-loop (HITL) architectures · Prompt chaining with structured reasoning

**Data Engineering & Analytics**
SQL analytics systems in PostgreSQL and SQL Server · ETL pipelines, star schema modeling, KPI design · Cohort analysis, retention modeling, Power BI dashboards with DAX

**Machine Learning**
Classification, regression, and clustering with scikit-learn · Feature engineering, model evaluation, fraud detection, and churn prediction pipelines
...
An end-to-end analytics pipeline modeling user performance and engagement, featuring leaderboards, streak tracking, rolling 7-day metrics, and question difficulty modeling with optimized queries.
`PostgreSQL` `Advanced SQL` `Window Functions` `KPI Modeling`

**E-Commerce Analytics Platform (SQL-Only)**
Complete SQL-based analytics system for transactional data — revenue, AOV, LTV, and retention metrics, plus cohort analysis and reusable reporting views.
`PostgreSQL` `SQL Aggregations` `Window Functions`

**Customer Churn Prediction**
End-to-end ML pipeline for churn prediction using telecom data, with feature engineering, model training/evaluation, and business-driven retention insights.
`Python` `Pandas` `scikit-learn` `Classification`

**Credit Card Fraud Detection**
Fraud detection model addressing severe class imbalance, with precision/recall optimization, F1-score evaluation, and a false-positive minimization strategy.
`Python` `Pandas` `scikit-learn`

**NLP Chatbot (Flask App)**
Rule-based chatbot using TF-IDF and cosine similarity, with a REST API backend and preprocessing pipeline.
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=sarahsair25&theme=tokyonight&hide_border=true" />
</p>
